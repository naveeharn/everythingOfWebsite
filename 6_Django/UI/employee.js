const employee = {
    ...
    <div>
        ...
        <button type="button" class="btn btn-primary m-2 fload-end" data-bs-toggle="modal" data-bs-target="#exampleModal" @click="addClick()">Add Employee</button>
        ...
        <tbody>
            <tr v-for="emp in employees">
                ...
                <td>
                    <button type="button" @click="editClick(emp)" class="btn btn-light mr-1" data-bs-toggle="modal" data-bs-target="#exampleModal">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="d-flex flex-row bd-highlight mb-3">
                ...
                <div class="p-2 w-58 bd-highlight">
            ...
            <button type="button" @click="updateClick()" v-if="EmployeeId!=0" class="btn btn-primary">Update</button>
    ...
    methods: {
        ...
        addClick() {
            ...
            this.Department = ""
            this.DateOfJoining = ""
            this.PhotoFileName = "IMG_0112.JPG"
        },
        editClick(emp) {
        ...
        imageUpload(event){
            ...
            axios.post(variables.API_URL + 'employee/savefile',fromData).then((response)=>{
