const department = {
    ...
    <div>
        ...
        <button type="button" class="btn btn-primary m-2 fload-end" data-bs-toggle="modal" data-bs-target="#exampleModal" @click="addClick()">Add Department</button>
        ...
        <tbody>
            <tr v-for="dep in departments">
                ...
                <td>
                    <button type="button" @click="editClick(dep)" class="btn btn-light mr-1" data-bs-toggle="modal" data-bs-target="#exampleModal">
    ...
    methods: {
        ...
        FilterFn(){
            ...
            this.departments = this.departmentswithoutFilter.filter(
                function(e) {
                    return e.DepartmentId.toString().toLowerCase().includes(
                        DepartmentIdFilter.toString().trim().toLowerCase()
                    )&& e.DepartmentName.toString().toLowerCase().includes(
